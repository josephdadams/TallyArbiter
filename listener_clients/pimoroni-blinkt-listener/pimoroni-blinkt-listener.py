...
if not os.path.isfile('config.ini'):
	...
	if os.path.isfile('deviceid.txt'):
		print("pimoroni-blinkt-listener has been updated since the last time you used it.")
...
parser.add_argument('--skip-blinkt', action='store_true', help='Skip the Blinkt! requirment and simulate it (only for debugging)')
