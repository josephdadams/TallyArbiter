 ...
 */
#define LED_PIN    0 // Left side bottom above 5V and GND
...
const int led_program = 3; //Built-in RGB red
const int led_preview = 4; //Built-in RGB green
const int led_aux = 5;     //Built-in RGB blue
#endif

//Tally Arbiter Server
char tallyarbiter_host[40] = "0.0.0.0"; //IP address of the Tally Arbiter Server
char tallyarbiter_port[6] = "4455"; //Default - edit if modified 
...
void setup() {
  ...
  logger("Tally extra initialised", "info");
  #endif
  connectToServer();
