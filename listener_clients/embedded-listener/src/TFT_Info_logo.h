//https://github.com/Bodmer/TFT_eSPI/blob/master/examples/Generic/TFT_Flash_Bitmap/Info.h
...
const uint16_t InfoLogoWidth = 32;
const uint16_t InfoLogoHeight = 32;

const unsigned short  InfoLogo[1024] PROGMEM={
